...
use crate::beam_protos::fn_execution::{
  beam_fn_external_worker_pool_server,
...
use crate::apache_beam::worker::sdk_worker::{
  Worker,
  WorkerEndpoints,
};
use beam_fn_external_worker_pool_server::{
  BeamFnExternalWorkerPool,
  BeamFnExternalWorkerPoolServer,
};
...
impl ExternalWorkerPool {
  ...
  pub async fn start(&self) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let svc = BeamFnExternalWorkerPoolServer::new(
      BeamFnExternalWorkerPoolService {
